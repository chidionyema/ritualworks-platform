...
var corsOrigins = builder.Configuration.GetSection("Cors:AllowedOrigins").Get<string[]>()
    ?? (builder.Environment.IsDevelopment()
        ? new[] { "http://localhost:4321", "https://haworks-platform.pages.dev", "https://haworks.pages.dev", "https://portfolio-showcase.pages.dev" }
        : new[] { "https://haworks-platform.pages.dev", "https://haworks.pages.dev", "https://portfolio-showcase.pages.dev" });
